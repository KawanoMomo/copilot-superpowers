...
7. **Spec review loop** — dispatch spec-reviewer subagent with precisely crafted review context; fix issues and re-dispatch until approved (max 3 iterations, then surface to human)
...
1. Dispatch spec-reviewer subagent with review context
